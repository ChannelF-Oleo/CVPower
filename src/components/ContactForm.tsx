...
export default function ContactForm() {
  ...
  const GOOGLE_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbwc8jrf9_bFejaazgVq3r8NS0j-DSOgwzYZiOa_XiS3XaS_wp4A6OpLVxmbkedBrpy5/exec"; 
  // Número de Abdia (Formato internacional sin +)
  const ABDIA_PHONE = "18299740013"; 
